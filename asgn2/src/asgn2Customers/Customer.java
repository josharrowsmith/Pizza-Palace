...
public abstract class Customer {
	...
	public Customer(String name, String mobileNumber, int locationX, int locationY, String type) throws CustomerException{
		if (name.length() > 20) throw new CustomerException("name is too long");
		if (name.length() < 1) throw new CustomerException("name is empty");
		if (mobileNumber.length() != 10 || mobileNumber.charAt(0) != '0') throw new CustomerException("MobileNumber is not valid");
		if (locationX > 10 || locationX < -10 || locationY > 10 || locationY < -10) throw new CustomerException("Customer too far from Store");
